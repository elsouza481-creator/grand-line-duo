...
fun main() {
    ...
    grandlineduo.game.character.ClassTrainingRulesTest.register()
    ...
    grandlineduo.game.world.ExplorationQuestEngineTest.register()
    ...
    grandlineduo.game.pvp.TrainingDuelAuthorityTest.register()
