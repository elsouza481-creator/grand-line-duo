...
fun main() {
    ...
    grandlineduo.game.quest.QuestFieldCoordinatorTest.register()
    ...
    grandlineduo.game.quest.QuestFieldRoutingTest.register()
    grandlineduo.game.quest.QuestHuntLanIntegrationTest.register()
    grandlineduo.game.quest.QuestFieldLanIntegrationTest.register()
